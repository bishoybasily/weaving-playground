...
* The original package name 'com.gmail.bishoybasily.playground.weaving.weaving-playground' is invalid and this project uses 'com.gmail.bishoybasily.playground.weaving.weaving_playground' instead.
...
```
$ docker run --rm -p 8080:8080 weaving-playground:0.0.1-SNAPSHOT
```
...
```
$ build/native/nativeCompile/weaving-playground
```
